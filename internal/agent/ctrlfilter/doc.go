...
// credential (issue poolpilot-cloud#27 — a leaked tunnel GUID alone is not enough), strips
...
// touch" write deny-list (issue poolpilot-cloud#27's interim measure) was removed by owner
